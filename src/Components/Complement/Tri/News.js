    ...
    <div>
      ...
      <div className="row" style={{ backgroundColor: "#2dc98a" }}>
        ...
        >
          <img
            style={{ marginLeft: "30%" }}
            src="https://parkivia.ancorathemes.com/wp-content/uploads/2017/12/invest2-1.png"
          ></img>
          <h4 style={{ textAlign: "center" }}>Cube LLC</h4>
          <p style={{ textAlign: "center" }}>
            Parking lots specifically for bicycles are becoming more prevalent
            in many countries. These may include bicycle parking racks and locks
            and modern.
          </p>
        </Card>
        <Card
          className="col s3 onhover"
          style={{ marginRight: "50px", height: "350px" }}
        >
          <img
            style={{ marginLeft: "30%" }}
            src="https://parkivia.ancorathemes.com/wp-content/uploads/2017/12/invest3-1.png"
          ></img>
        ...
        >
          <img
            style={{ marginLeft: "30%" }}
            src="https://parkivia.ancorathemes.com/wp-content/uploads/2017/12/invest1-1.png"
          ></img>
